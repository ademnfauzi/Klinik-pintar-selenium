...
driver.find_element(switch_case("id"), "rawat-jalan_semua-status_tindak-lanjut_tab_click").click()
wait(1)
rawatJalan = driver.find_element(switch_case("id"), "rawat-jalan_semua-status_tindak-lanjut_tab_click")
wait(1)
...
rawatJalan.send_keys(Keys.DOWN)
wait(1)
call_screenshoot(saveWord,saveImage,"Menampilkan Semua Data Tindak Lanjut")

end(saveImage,saveWord,'KP0005-TCSN002')