...
wait(5)
driver.find_element(switch_case("id"), "rawat-jalan_registrasi_semua-registrasi_tab_click").click()
wait(5)
call_screenshoot(saveWord,saveImage,"Menampilkan Semua Data Untuk Semua Registrasi")


end(saveImage,saveWord,'KP0013-TCSN001')