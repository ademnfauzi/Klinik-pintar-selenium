...
wait(5)
driver.find_element(switch_case("id"), "rawat-jalan_reservasi_menunggu-konfirmasi_tab_click").click()
wait(5)
call_screenshoot(saveWord,saveImage,"Menampilkan Semua Data Menunggu Konfirmasi Untuk Reservasi")

end(saveImage,saveWord,'KP0009-TCSN001')