...
wait(5)
Filter_Polyclinic_Doctor("BPJS","BPJS")
wait(5)
call_screenshoot(saveWord,saveImage,"Menampilkan Hasil Filter Poliklinik dan Dokter")


end(saveImage,saveWord,'KP0004-TCSN001')